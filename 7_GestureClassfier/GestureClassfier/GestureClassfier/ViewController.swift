...
class ViewController: UIViewController {
    ...
    static let windowOffsetAsBytes = ViewController.windowOffset * ViewController.numberOfFeatures * MemoryLayout<Double>.stride
    static let windowSizeAsBytes = ViewController.windowSize * ViewController.numberOfFeatures * MemoryLayout<Double>.stride
    ...
    func buffer(_ motionData: CMDeviceMotion)
    {
        for offset in [0, ViewController.windowSize]
        {
            ...
            if index >= ViewController.bufferSize {continue}
